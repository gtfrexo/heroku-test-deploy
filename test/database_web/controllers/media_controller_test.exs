defmodule DatabaseWeb.MediaControllerTest do
  use DatabaseWeb.ConnCase

  alias Database.Medias
  alias Database.Medias.Media

  @create_attrs %{deleted_at: "2010-04-17 14:00:00.000000Z", description: "some description", media_type: "some media_type", url: "some url", venue_id: 1, event_id: 1}
