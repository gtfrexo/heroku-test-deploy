defmodule DatabaseWeb.VenueControllerTest do
  use DatabaseWeb.ConnCase

  alias Database.Venues
  alias Database.Venues.Venue

  @create_attrs %{category: "some category", description: "some description", name: "some name", name_full: "some name_full", location_id: 1, pic: 1}
