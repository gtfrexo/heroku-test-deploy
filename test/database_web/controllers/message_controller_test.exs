defmodule DatabaseWeb.MessageControllerTest do
  use DatabaseWeb.ConnCase

  alias Database.Messages
  alias Database.Messages.Message

  @create_attrs %{content: "some content", read_at: "2010-04-17 14:00:00.000000Z", from_person: 1, to_person: 1, sent_at: "2010-04-17 14:00:00.000000Z"}
