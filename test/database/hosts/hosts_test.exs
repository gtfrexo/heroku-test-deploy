defmodule Database.HostsTest do
  use Database.DataCase

  alias Database.Hosts

  describe "hosts" do
    alias Database.Hosts.Host

    @valid_attrs %{description: "some description", name: "some name", name_full: "some name_full", venue_id: 1}
    @update_attrs %{description: "some updated description", name: "some updated name", name_full: "some updated name_full", venue_id: 1}
    @invalid_attrs %{description: nil, name: nil, name_full: nil, venue_id: nil}
