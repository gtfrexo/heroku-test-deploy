defmodule Database.VenuesTest do
  use Database.DataCase

  alias Database.Venues

  describe "venues" do
    alias Database.Venues.Venue

    @valid_attrs %{category: "some category", description: "some description", name: "some name", name_full: "some name_full", location_id: 1, pic: 1}
    @update_attrs %{category: "some updated category", description: "some updated description", name: "some updated name", name_full: "some updated name_full", location_id: 1, pic: 1}
    @invalid_attrs %{category: nil, description: nil, name: nil, name_full: nil, location_id: nil, pic: nil}
