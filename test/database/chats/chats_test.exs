defmodule Database.ChatsTest do
  ...
  describe "chats" do
    ...
    @valid_attrs %{is_blocked: true, pool_id: 1, person_id: 1}
    ...
    test "create_chat/1 with valid data creates a chat" do
      ...
      assert chat.is_blocked == true
      assert chat.pool_id == 1
      assert chat.person_id == 1
    end
